    ...
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            catch (Exception ex)
            {
                ...
                string borrarNoSocio = "CREATE procedure borrarNoSocio(IN documento int) BEGIN DELETE FROM nosocio WHERE dni LIKE documento; END //";
                MySqlScript comandoProcBorrarNoSocio = new MySqlScript(sqlCon, borrarNoSocio);
                comandoProcBorrarNoSocio.Delimiter = "//";
                ...
                comandoProcBorrarNoSocio.Execute();
